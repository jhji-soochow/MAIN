...
from model.ain0 import make_model
...
class MAIN(nn.Module):
    def __init__(self, args):
        ...
        if self.modelnumber == 1:
            self.state_dicts = [torch.load(ckpt_dir + '0_96x2/' + 'model/model_latest.pt', map_location='cpu')]
...
def test(args, model=None, use_cuda=True):
    ...
    if args.save:
        save_dir = "../experiment/AIN0_96x2/testoutput/"
...
if __name__=="__main__":
    ...
    parser.add_argument('--modelscale', type=int, default=1,
